...
instance AWSRequest ListContributorInsights where
        type Rs ListContributorInsights =
             ListContributorInsightsResponse
...
instance Hashable ListContributorInsights where

instance NFData ListContributorInsights where
...
instance NFData ListContributorInsightsResponse where
