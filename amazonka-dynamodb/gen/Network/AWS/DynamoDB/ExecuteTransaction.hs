...
data ExecuteTransaction = ExecuteTransaction'
  { _etClientRequestToken :: !(Maybe Text)
  , _etTransactStatements :: !(List1 ParameterizedStatement)
...
data ExecuteTransactionResponse = ExecuteTransactionResponse'
  { _etrsResponses :: !(Maybe (List1 ItemResponse))
...
executeTransactionResponse pResponseStatus_ =
  ExecuteTransactionResponse'
    {_etrsResponses = Nothing, _etrsResponseStatus = pResponseStatus_}
