...
instance AWSRequest DescribeTableReplicaAutoScaling
         where
...
instance NFData DescribeTableReplicaAutoScaling where

instance ToHeaders DescribeTableReplicaAutoScaling
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribeTableReplicaAutoScaling
         where
