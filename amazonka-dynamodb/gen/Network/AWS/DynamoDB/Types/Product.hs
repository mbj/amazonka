...
data BatchStatementError = BatchStatementError'
  { _bseCode :: !(Maybe BatchStatementErrorCodeEnum)
...
data BatchStatementRequest = BatchStatementRequest'
  { _bsrConsistentRead :: !(Maybe Bool)
  , _bsrParameters :: !(Maybe (List1 AttributeValue))
  , _bsrStatement :: !Text
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
data BatchStatementResponse = BatchStatementResponse'
  { _bError :: !(Maybe BatchStatementError)
  , _bItem :: !(Maybe (Map Text AttributeValue))
...
batchStatementResponse =
  BatchStatementResponse'
    {_bError = Nothing, _bItem = Nothing, _bTableName = Nothing}
...
data ExportSummary = ExportSummary'
  { _esExportStatus :: !(Maybe ExportStatus)
...
data KinesisDataStreamDestination = KinesisDataStreamDestination'
  { _kdsdDestinationStatus :: !(Maybe DestinationStatus)
  , _kdsdStreamARN :: !(Maybe Text)
  , _kdsdDestinationStatusDescription :: !(Maybe Text)
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
kinesisStreamingDestinationInput pTableName_ pStreamARN_ =
  KinesisStreamingDestinationInput'
    {_ksdiTableName = pTableName_, _ksdiStreamARN = pStreamARN_}
...
data KinesisStreamingDestinationOutput = KinesisStreamingDestinationOutput'
  { _ksdoDestinationStatus :: !(Maybe DestinationStatus)
  , _ksdoStreamARN :: !(Maybe Text)
  , _ksdoTableName :: !(Maybe Text)
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
data ParameterizedStatement = ParameterizedStatement'
  { _psParameters :: !(Maybe (List1 AttributeValue))
  , _psStatement :: !Text
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
parameterizedStatement pStatement_ =
  ParameterizedStatement' {_psParameters = Nothing, _psStatement = pStatement_}
