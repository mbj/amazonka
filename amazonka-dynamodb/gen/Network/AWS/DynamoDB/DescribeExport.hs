...
describeExport
    :: Text -- ^ 'deExportARN'
    -> DescribeExport
describeExport pExportARN_ = DescribeExport' {_deExportARN = pExportARN_}
...
data DescribeExportResponse = DescribeExportResponse'
  { _deersExportDescription :: !(Maybe ExportDescription)
...
describeExportResponse pResponseStatus_ =
  DescribeExportResponse'
    {_deersExportDescription = Nothing, _deersResponseStatus = pResponseStatus_}
