...
instance AWSRequest UpdateTableReplicaAutoScaling
         where
...
instance Hashable UpdateTableReplicaAutoScaling where

instance NFData UpdateTableReplicaAutoScaling where

instance ToHeaders UpdateTableReplicaAutoScaling
         where
        toHeaders
          = const
              (mconcat
